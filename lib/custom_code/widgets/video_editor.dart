...
import '/custom_code/widgets/video_result_popup.dart';
...
class _VideoEditorState extends State<VideoEditor> {
  ...
  Future<File> convertFFUploadedFileToFile(
    ...
    final path = '${directory.path}/${ffUploadedFile.name}';
    // Save the file bytes to the local path
    final file = File(path);
    await file.writeAsBytes(ffUploadedFile.bytes!);
    // Return the file
    return file;
  }
  ...
  Future<void> _initializeVideoEditor() async {
    try {
      File videoFile = await convertFFUploadedFileToFile(widget.file);
